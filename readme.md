...
서인욱 - Whisper STT 테스트(영어, 한국어, 일본어,중국어) 완료, TTS 음성 모델(영어, 한국어, 일본어, 중국어(간체)) 테스트 완료, 실시간 대화 구조(OpenAI API키 사용-ChatGPT 답변 생성) 테스트 완료, MBTI - ESTJ 유형 자료조사 및 정리, ESTJ 유형을 프롬프트로 구현, AI에 ESTJ 유형 도슨트 프롬프트 부여 후 테스트 진행
